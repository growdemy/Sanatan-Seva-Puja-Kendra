  ...
  return (
    <section className="relative pt-12 lg:pt-20 pb-16 lg:pb-24 overflow-hidden flex items-center min-h-[90vh]">
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-10 lg:px-20 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-10 w-full">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#FEEBD2] text-[#78550E] text-[12px] font-bold uppercase tracking-widest px-4 py-[6px] rounded-[50px] mb-[18px] shadow-none">
          ...
          <h1 className="text-[36px] leading-[40px] md:text-5xl lg:text-[56px] md:leading-[1.15] font-display text-brand-primary-deep font-bold mb-[16px]">
            Sanctified Vedic Rites for Life's <span className="text-brand-gold-base italic">Auspicious Blessings</span>
          </h1>
          
          <p className="font-medium text-[14px] leading-[23px] md:text-[16px] md:leading-[27px] text-text-secondary mb-[28px] max-w-[540px]">
          ...
          {/* Stats Row */}
          <div className="flex flex-wrap items-center gap-x-5 gap-y-3 mb-[30px] font-medium text-[12px] leading-[22px] md:text-[13px] md:leading-[22px] text-[#3D1A22]">
