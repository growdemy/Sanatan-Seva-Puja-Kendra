...
interface HealthWellbeingPageProps {
  onBack?: () => void;
}

export default function HealthWellbeingPage({ onBack: _onBack }: HealthWellbeingPageProps) {
  const pujas = [
        ...
        <div className="relative overflow-hidden rounded-[24px] bg-[#FFF8F6] border border-[#E8C37D]/30 p-8 md:p-16 mb-16 text-center shadow-xl">
          ...
          >
            ...
            <h1 className="text-[36px] leading-[44px] md:text-[56px] md:leading-[68px] font-display font-bold text-[#3D1A22] mb-6">
              Health & <span className="text-[#c59a4e] italic">Well-being</span>
            </h1>
            
            <p className="text-[14px] leading-[23px] md:text-[16px] md:leading-[27px] text-[#5C3B43]">
              Explore our comprehensive catalogue of authentic Health & Well-being pujas. Every ritual is performed by expert Sanskrit acharyas with strict adherence to ancient scriptures, precise mantra intonation, and unadulterated samagri.
            </p>
          </motion.div>
        </div>
